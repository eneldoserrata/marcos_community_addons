 ...
 */
odoo.define('marcos_support_branding.crash_manager', function (require) {
    ...
    CrashManager.include({
        ...
        show_error: function (error) {
            ...
            var support_branding_support_email = false;
            var support_branding_company_name = false;

            ir_config_parameter.call('get_param', ['support_branding.support_email'])
                .then(function (email) {
                    support_branding_support_email = email

                    ir_config_parameter.call('get_param', ['support_branding.company_name'])
                        .then(function (name) {
                    ...
                    if (support_branding_support_email) {

                        $form.attr(
                            'action',
                            'mailto:' + support_branding_support_email);
                        ...
                        $button.click(function (ev) {
                            ...
                            mail_mail.call(
                                ...
                                [{
                                    state: 'outgoing',
                                    auto_delete: false,
                                    email_to: support_branding_support_email,
                                    subject: $subject.val(),
                    ...
                    if (support_branding_company_name) {
                        $button.text(
                            _.str.sprintf(
                                openerp.web._t('Email to %s'),
                                support_branding_company_name));
                    }
                    $form.prependTo(
