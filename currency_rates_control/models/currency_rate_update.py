...
DO_BC_supported_currency_array = ["USD"]

supported_currecies = {
    'DO_BC_getter': DO_BC_supported_currency_array,
...
class Currency_rate_update_service(models.Model):
    ...
    def _onchange_service(self):
        ...
        if self.service:
            ...
            enable_currency = company_conf.group_multi_currency
    ...
    service = fields.Selection(
        [('DO_BC_getter', 'Banco Central de la Republica Dominicana'),
